...
<div class="row" >
    <div class="col-md-3 ">
                                ...
                                <select class="framed width-100 " name="purpose"  >
                                    ...
                                    @elseif($property[0]->purpose == 'Sale')
    ...
    <div class="col-md-3 ">
        ...
        <select class="framed width-100" name="property_type"   >
...
@if($property[0]->property_type == 'Houses')
            ...
            <option selected value="Houses">  Houses</option>
