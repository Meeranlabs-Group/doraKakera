    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="checkbox" name="5">Waste Disposal</label></li><li><label><input type="checkbox" name="6">Service Elevator in Building</label></li>                
        ...
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="Intercom" name="5">Intercom</label></li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="checkbox" name="1">Lawn or Garden</label></li>
        ...
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="checkbox" name="3">Facilities for Disabled</label></li>
            </ul>
            <!--end checkboxes-->
        </div>
        <!--end col-md-4-->
