    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="checkbox" name="Buisness_Center_or_Media_Room_in_Building">Buisness Center or Media Room in Building</label></li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="text" name="Other Healthcare_and_Recreation_Facilities">Other Healthcare and Recreation Facilities</label></li>
