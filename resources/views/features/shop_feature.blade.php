<section id="features">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="checkbox" name="1">Central Air Conditioning</label></li>
                <li><label><input type="checkbox" name="2">Central Heating</label></li>
                <li><label><input type="checkbox" name="3">Waste Disposal</label></li><li><label><input type="checkbox" name="4">Service Elevator in Building</label></li>                
        ...
        <div class="col-md-4">
            ...
            <ul class="checkboxes inline half list-unstyled">
                ...
                <li><label><input type="checkbox" name="3">ATM Credit Card Machines in Building</label></li>
    ...
    <div class="row">
        <div class="col-md-4">
            <h3>Rooms</h3>
            <ul class="checkboxes inline half list-unstyled">
                <li><label><input type="checkbox" name="1">All Are Text</label></li>
