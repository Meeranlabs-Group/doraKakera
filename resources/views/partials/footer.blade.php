...
<footer id="page-footer" >
    ...
    <div class="row-one" style="padding:10px;margin: 0px;">
    ...
    <div class="row-two clearfix" style="background-color:#002f6c">
        <div class="container">
           ...
           <h3>Head Office</h3>
            ...
            G -16, Phase 1, Masjid Chowk, Defence Housing Authority Lahore Cantt., Pakistan.<br>
            UAN: +92-42-111-124-124
                <br>
            Tel: +92-42-35727771-4, 35728881-4
                <br>
            Fax: +92-42-35729990
                <br>
            Email: info@chohanestate.com
            </div>
            ...
            <h3> DHA Phase 6</h3>
            <hr>
            MB 2, Phase 6, Defence Housing Authority, Lahore
            <br>
            UAN: +92-42-111-125-125
            <br>
            Cell: +312 111 5555
            <br>
            Email: info@chohanestate.com
