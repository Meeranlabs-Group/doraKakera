                        ...
                        <div class="inner">
                            <div class="container">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-2 col-sm-2 col-md-offset-3">
                                        <div class="form-group">
                                            <button type="button" id="show" class="btn btn-primary">BUY</button>
                                        </div>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-md-offset-2 search-bar"  id="1">
                                        <div class="col-md-4 col-sm-4 ">
                                            <div class="form-group">
                                                <label style="color: white">Property Type</label>
                                                <select class="form-control framed white">
                            ...
                            <!--end container-->
                            <div class="bg-transfer"><img src="assets/img/sample.jpg" alt=""></div>
                            <!--end bg-transfer-->
                        </div>
                        <!--end inner-->
                    </div>
